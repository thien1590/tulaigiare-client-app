cordova.define("cordova-background-geolocation-lt.BackgroundGeolocationMock", function(require, exports, module) { var cordovaProxy = require('cordova/exec/proxy');
